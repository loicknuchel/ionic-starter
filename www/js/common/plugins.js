(function(){
  ...
  angular.module('app')
    ...
    .factory('DevicePlugin', DevicePlugin)                                // for Device plugin : org.apache.cordova.device (https://github.com/apache/cordova-plugin-device)
    .factory('DialogPlugin', DialogPlugin)                                // for Dialogs plugin : org.apache.cordova.dialogs (https://github.com/apache/cordova-plugin-dialogs)
    .factory('ToastPlugin', ToastPlugin)                                  // for Toast plugin : https://github.com/EddyVerbruggen/Toast-PhoneGap-Plugin
    .factory('GeolocationPlugin', GeolocationPlugin)                      // for Geolocation plugin : org.apache.cordova.geolocation (https://github.com/apache/cordova-plugin-geolocation)
    .factory('BackgroundGeolocationPlugin', BackgroundGeolocationPlugin)  // for BackgroundGeolocation plugin : https://github.com/christocracy/cordova-plugin-background-geolocation
    .factory('LocalNotificationPlugin', LocalNotificationPlugin)          // for LocalNotification plugin : de.appplant.cordova.plugin.local-notification (https://github.com/katzer/cordova-plugin-local-notifications/)
    .factory('CameraPlugin', CameraPlugin)                                // for Camera plugin : org.apache.cordova.camera (https://github.com/apache/cordova-plugin-camera)
    .factory('SharingPlugin', SharingPlugin)                              // for Sharing plugin : https://github.com/EddyVerbruggen/SocialSharing-PhoneGap-Plugin
    .factory('MediaPlugin', MediaPlugin)                                  // for Media plugin : org.apache.cordova.media (https://github.com/apache/cordova-plugin-media)
    .factory('PushPlugin', PushPlugin)                                    // for Push plugin : https://github.com/phonegap-build/PushPlugin
    .factory('ParsePlugin', ParsePlugin)                                  // for Parse plugin : https://github.com/umurgdk/phonegap-parse-plugin
    .factory('DeviceAccountsPlugin', DeviceAccountsPlugin)                // for DeviceAccounts plugin : https://github.com/loicknuchel/cordova-device-accounts
  ;
